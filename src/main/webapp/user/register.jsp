...
<head>
    ...
    <style>
        ...
        .input-group .form-control.is-valid + .btn { border-color: #198754 !important; }
        .input-group .form-control.is-invalid + .btn { border-color: #dc3545 !important; }
        .input-group .form-control:not(.is-valid):not(.is-invalid) + .btn { border-color: #ced4da; }
    </style>
</head>
<body>

<%-- === MAIN CONTENT WRAPPER === --%>
<%-- This centers the card and pushes the footer down --%>
<div class="flex-grow-1 d-flex flex-column justify-content-center align-items-center w-100 position-relative py-5">

    <a href="${pageContext.request.contextPath}/index.jsp"
       class="btn btn-light position-absolute top-0 start-0 m-4 shadow-sm rounded-pill px-4 fw-bold"
       style="color: #2c1a4d; text-decoration: none; z-index: 10;">
        &larr; Home
    </a>
