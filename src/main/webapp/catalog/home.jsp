                        ...
                        <div class="card h-100 soldout-event-card shadow-sm">
                            ...
                            <div class="card-footer bg-light border-top-0 pb-3">
                                <button class="btn btn-secondary w-100"
                                        onclick="openDetailsModal('${event.id}', '${event.title}', this, '${event.eventDate}', '${event.location}', '${event.price}', '${event.imageUrl}', 0, 'soldout')">
                                    View Details (Full)
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="col-md-4 mb-4 event-item">
                        <div class="card h-100 past-event-card shadow-sm">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute top-50 start-50 translate-middle">
                                    <span class="badge bg-dark fs-5 shadow">EVENT ENDED</span>
                                </div>
                            </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0">
            ...
            <div class="position-relative">
                ...
                <button type="button" class="btn-close position-absolute top-0 end-0 m-3 bg-white p-2 shadow-sm" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                ...
                <form action="${pageContext.request.contextPath}/CartServlet" method="post" class="mt-3">
                    ...
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-8">
                            ...
                            <button type="submit" id="modalBtn" class="btn btn-success w-100 fw-bold" style="background-color: #2c1a4d; border: none;">
                                Add to Cart
                            </button>
                        </div>
                    </div>
